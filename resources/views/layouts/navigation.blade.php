        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- ... setelah Nav Link Dashboard ... -->
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                <x-nav-link :href="route('kursus.index')" :active="request()->routeIs('kursus.index')">
                    {{ __('Kursus') }}
                </x-nav-link>
                ...
                <x-nav-link :href="route('laporan.peserta')" :active="request()->routeIs('laporan.peserta')">
                    {{ __('Laporan') }}
                </x-nav-link>
            </div>
            </div>
